...
part 'amity_edit_group_member_permissions_cubit.dart';
...
class AmityEditGroupMemberPermissionsPage extends NewBasePage {
  ...
  AmityEditGroupMemberPermissionsPage({Key? key, required this.channel})
      : super(key: key, pageId: 'edit_group_member_permissions_page');

  @override
  Widget buildPage(BuildContext context) {
    return BlocProvider(
      create: (context) => AmityEditGroupMemberPermissionsCubit(channel),
      child:
          BlocBuilder<AmityEditGroupMemberPermissionsCubit, AmityGroupMemberPermissionsState>(
        ...
        children: [
          ...
          _buildPermissionOption(
            ...
            onChanged: (permission) => context
                .read<AmityEditGroupMemberPermissionsCubit>()
