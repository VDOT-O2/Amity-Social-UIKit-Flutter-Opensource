...
class StoryVideoPlayerBloc extends Bloc<StoryVideoPlayerEvent, StoryVideoPlayerState> {
  ...
  double _resolveAspectRatio(VideoPlayerController controller, int rotationDegrees, bool isFromGallery) {
    ...
    // Only apply rotation correction for videos from gallery
    // Captured videos are always portrait-locked, so we ignore rotation metadata
    if (isFromGallery && (rotationDegrees == 90 || rotationDegrees == 270)) {
