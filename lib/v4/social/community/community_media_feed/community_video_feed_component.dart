...
import 'package:amity_uikit_beta_service/v4/social/user/video_feed/element/user_video_feed_element.dart';
...
class AmityCommunityVideoFeedComponent extends NewBaseComponent {
  ...
  AmityCommunityVideoFeedComponent({
    ...
    this.userFollowInfo,
  }) : super(componentId: "community_video_feed") {
  ...
  Widget buildComponent(BuildContext context) {
    return BlocProvider<CommunityMediaFeedBloc>(
      create: (context) => CommunityMediaFeedBloc(
          ...
          feedType: CommunityMediaFeedType.video,
          scrollController: scrollController),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            width: 252,
            child: Text(context.l10n.feed_no_videos,
